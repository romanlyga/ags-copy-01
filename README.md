...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5feafc588880180015745488
...
To start editing your site, you can use the Sanity interface at https://ags-afc58.sanity.studio/.
...
Generated at `2020-12-29T09:52:49.395Z` by Stackbit version `0.3.42`.